...
import com.rodrigopr.marcador_presentation.search.components.SearchTextField
import com.rodrigopr.core.R
import com.rodrigopr.marcador_domain.model.MealType
import com.rodrigopr.marcador_presentation.search.components.DetectableFoodItem
...
fun SearchScreen(
    ...
    Column(
        ...
        LazyColumn(modifier = Modifier.fillMaxSize()) {
            items(state.detectableFood) { food ->
                DetectableFoodItem(
                    detectableFoodUiState = food,
                    onClick = {
